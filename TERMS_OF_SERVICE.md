...
### 4.4 Price Changes
Subscription pricing may change with reasonable advance notice. Continued use of the App after a price change constitutes acceptance of the new price.
...
- Submit images that are not restaurant or retail receipts with the intent to abuse the AI parsing service.
...
The App uses artificial intelligence (Anthropic Claude) to extract line items from receipt images. **AI parsing is not guaranteed to be accurate.** Results may be incorrect, incomplete, or missing items due to:
...
Continued use of the App after updated Terms take effect constitutes your acceptance.
